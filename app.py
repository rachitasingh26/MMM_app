...
def clusters(df):
    ...
    def main():
        ...
        st.pyplot(fig)
        st.empty()
        st.write("1. Cluster 1 (red): These are average income earners with average spending scores. They are cautious with their spending.")
        st.write("2. Cluster 2 (yellow): The customers in this group are high income earners and with high spending scores. They bring in profit. Discounts and other offers targeted at this group will increase their spending score and maximize profit.")
        st.write("3. Cluster 3 (green): This group of customers have a higher income but they do not spend more at the store. One of the assumption could be that they are not satisfied with the services rendered. They are another ideal group to be targeted by the marketing team because they have the potential to bring in increased profit.")
        st.write("4. Cluster 4 (blue): Low income earners with low spending score.")
        st.write("5. Cluster 5 (purple): These are low income earning customers with high spending scores. One assumption for this can be that they enjoy and are satisfied with the services rendered.")
        st.empty()
